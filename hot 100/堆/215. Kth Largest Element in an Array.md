...
## 题目截图：
---
![](assets/215.%20Kth%20Largest%20Element%20in%20an%20Array/file-20260305100631683.png)
...
        i, j = left + 1, right
        while True:
            while i <= j and nums[i] < pivot: # 必须i《=j， 这是因为当i == j 的时候这个元素必须要检查，如果只是i< j，那么i == j的这个元素检查不了和pivot的大小关系
                i += 1
            # 此时 nums[i] >= pivot
...
                left = i + 1
```
![](assets/215.%20Kth%20Largest%20Element%20in%20an%20Array/file-20260305100747273.png)